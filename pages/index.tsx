  ...
  return (
    <div className="homepage">
      ...
      <header>
        ...
        >
          ...
          <div style={{ display: 'flex', gap: '20px' }}>
            <Button
              ...
              style={{
                backgroundColor: '#54D8B3',
                color: 'white',
                borderRadius: '15px',
              }}
            >
              <GoogleIcon fontSize="small" /> Log In
            </Button>
          </div>
        </div>
        ...
        >
          <div style={{ textAlign: 'left' }}>
            ...
            >
              Opal Labs is the flexible writing app that adapts to the way you think.
            </h3>
          </div>
      ...
      <main style={{ marginTop: '80px' }}>
        <section
          className="responsive-container use-section"
          style={{
            display: 'flex',
            gap: '100px',
            padding: '0 110px',
        ...
        >
          <div style={{ textAlign: 'left' }}>
            ...
            <p style={{ color: '#A3A3A3' }}>
              Our note-taking platform is perfect for personal use. Organize your thoughts, jot down
              your ideas, or simply keep track of your daily activities. With our rich text editor,
              you can style your notes to your liking.
            </p>

            <h2>For School Use.</h2>
            <p style={{ color: '#A3A3A3' }}>
              Whether you're a student or a teacher, our platform can help you stay on top of your
              academic work. Create subpages for different subjects or projects, embed relevant
              webpages, and even track your progress with checkboxes.
            </p>

            <h2>For Work Use.</h2>
            <p style={{ color: '#A3A3A3' }}>
              Stay productive with our platform's features tailored for professional use.
              Collaborate with your team by sharing your notes, keep track of tasks with checkboxes,
              and present your ideas clearly with our callout component.
            </p>
          </div>
          ...
          <div style={{ padding: '0 30px' }}>
            ...
            <p style={{ fontSize: '18px' }}>
              ...
              <span
                onClick={() => signIn('google')}
                style={{ color: '#54D8B3', cursor: 'pointer' }}
              >
                Start Now
              </span>
            </p>
        ...
        <section style={{ marginTop: '80px' }}>
          ...
          >
            From personal notes to journal entries, knowledge bases, and project management, Opal
            Labs gives you the tools to come up with idea and oraganize them.
          </p>
        ...
        <section style={{ marginTop: '120px' }}>
          ...
          >
            <div className="glass hover-on-div" style={{ padding: '20px 30px' }}>
              <h3>Customer 1</h3>
              <p style={{ color: '#A3A3A3' }}>
                “An incredible app. The distinction between Opal Labs and its competitors is beyond
                words.”
              </p>
            </div>
            ...
            <div className="glass hover-on-div" style={{ padding: '20px 30px' }}>
              <h3>Customer 2</h3>
              <p style={{ color: '#A3A3A3' }}>
                “Discovering Opal Labs has been a game-changer for my productivity, with its
            ...
            <div className="glass hover-on-div" style={{ padding: '20px 30px' }}>
              <h3>Customer 3</h3>
              <p style={{ color: '#A3A3A3' }}>
                “Wow. Just wow. I've found myself effortlessly organizing my thoughts and tasks like
                never before.”
              </p>
            </div>
          </div>
        ...
        >
          <div>
            ...
            <p style={{ textAlign: 'center', marginTop: '20px' }}>
              © 2024 Opal Labs. All rights reserved.
            </p>
          </div>
          <div>
            <p style={{ fontWeight: 'bold' }}>Follow Us</p>
            <div
              className="footer-links responsive-container"
              style={{ display: 'flex', gap: '20px' }}
            >
              <a
                href="https://abdulhadikhan.netlify.app/"
                target="_blank"
                rel="noreferrer"
              ...
              <a
                href="https://www.linkedin.com/in/abdul-hadi-khan/"
                target="_blank"
                rel="noreferrer"
                aria-label="LinkedIn"
              >
              ...
              <a
                href="https://www.youtube.com/@learningexpressway/videos"
                target="_blank"
                rel="noreferrer"
                aria-label="YouTube"
              >
              ...
              <a
                href="https://github.com/AbdulDevHub/"
                target="_blank"
                rel="noreferrer"
                aria-label="GitHub"
              >
